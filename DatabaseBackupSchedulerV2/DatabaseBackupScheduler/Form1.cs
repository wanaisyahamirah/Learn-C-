    ...
    public partial class Form1 : Form
    {
        ...
        private   void btnBackup_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("Database: " + dbName + "Backup Successfully Completed! \nLocation: " + backupFilePath, "Backup", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Database: " + dbName + "Backup Failed! \nTargeted Location: ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            Cursor = Cursors.Default;
